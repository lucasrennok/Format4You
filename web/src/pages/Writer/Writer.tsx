  ...
  return (
    <div className="page-writer">
      ...
      <div className="content">
        ...
        <textarea onFocus={handleWriterChange} placeholder="Type something" defaultValue={defaultTextArea} onChange={handleWriterChange} className="autoTextArea" />
